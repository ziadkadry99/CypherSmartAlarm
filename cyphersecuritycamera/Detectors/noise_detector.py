...
from cyphersecuritycamera.locks.lock_manager import Lock_Manager
...
class Noise_Detector(threading.Thread):
	...
	def determine_threshold(self):
		...
		@return float
		"""
		logger.info("Determining threshold...")
		res = []
		for x in range(50):
		...
		logger.info("Setting threshold to: " + str(threshold))
		return threshold
	...
	def start_recording(self):
		...
		logger.info("Noise detected! Recording...")
	...
	def run(self):
		...
		try:
			while True:
				...
				# These commented lines handle the recording and archiving of the audio
